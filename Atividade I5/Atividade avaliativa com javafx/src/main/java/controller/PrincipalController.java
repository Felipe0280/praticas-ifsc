...
public class PrincipalController {
    ...
    void btnSomarClick(ActionEvent event) throws IOException {
     ...
     @FXML
    void btnClienteClick(ActionEvent event)throws IOException  {
        ...
        //Passar a instância do controller para a nova tela para manipular por meio do controller
        CadastroClienteController ccc = loader.getController();
        ccc.setStage(novaTela);

         novaTela.setOnShown(evento -> {
            ccc.ajustarElementosJanela();
        });
         
        novaTela.setTitle("Cadastro de Cliente");
        novaTela.setScene(new Scene(root));
        novaTela.show();
    }
